Anybody who's worked in ML or AI knows how important high-quality, clean data is for training a good model. These days, a lot of people throw around the word _"neural network"_ today in regards to AI and LLMs, but what you may not know is that this model architecture is actually based on the human brain and **its own neural network.**
...
![NN vs Brain](/assets/nn-brain1.png)
...
This process is known as **backpropagation**, and it’s the mechanism by which the model learns from error and updates its internal representations (learning from mistakes).
...
```go
Which is why “fixing your inputs” matters even more as you get older you’re no longer training a model from scratch, but fine-tuning one with deeply entrenched priors.
```

# What are the Inputs?

In AI, that data might be images, text, sound, etc. but for your brain the _"data"_ is your daily lived experiences:
...
At the end of the day, you are a neural network, one that has been training since the moment you were born.

Like any model, the outputs you produce - your thoughts, beliefs, decisions, and habits are shaped by the inputs you receive and the feedback you internalize. Your environment, the media you consume, and the people you spend time with all act as training data.

Artificial neural networks are designed to learn and adapt. So are you.

The difference is that, unlike a model, you have some say in what you train on.

Whether you’re building an ANN or trying to build a better you, the principle is the same:
